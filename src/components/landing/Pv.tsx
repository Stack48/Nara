            ...
            <div className="mx-auto max-w-[1180px] px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {cards.map((card, index) => (
                        <div key={index} className="flex flex-col bg-white/[0.03] border border-white/10 rounded-[2rem] p-4 pb-8 hover:-translate-y-2 hover:border-white/20 transition-all duration-500 hover:shadow-[0_20px_40px_rgba(0,0,0,0.4)] group">
