            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 lg:grid-rows-[3fr_2fr] gap-6 flex-1 min-h-0">
                ...
                <div className="lg:col-span-9 relative bg-[#151515] rounded-2xl border border-neutral-800 flex flex-col overflow-hidden">
                    <div className="absolute inset-0 z-0">
                        <Image src={lgseo} alt="Cover Let God Sort Em Out" fill className="object-cover opacity-50 mix-blend-lighten" />
                    ...
                    <div className="relative z-10 p-8 flex flex-col lg:flex-row items-center justify-between gap-8 h-full">
                            ...
                            <div className="mt-4">
                                ...
                                <p className="text-xl text-neutral-300 mt-1">
                                    ...
                                    {ficoSong?.projectName ? (
                                        ...
                                        <span className="underline decoration-neutral-500 underline-offset-4 cursor-pointer">Standalone</span>
                                    )}
                                </p>
                            </div>
                            <div className="flex items-center gap-3 mt-6">
                                <span className="text-neutral-400 text-sm">Last edited 8 minutes ago</span>
                                <div className="flex items-center gap-2">
                                    <Image src={haslem} alt="Udonis Haslem" width={28} height={28} className="rounded-full object-cover w-7 h-7" />
                                    <span className="text-neutral-400 text-sm">Udonis Haslem</span>
                                </div>
                            </div>
                            <div className="flex items-center gap-4 mt-8">
                                <Link href="/lyric-editor" className="flex items-center gap-2 bg-gradient-to-r from-[#AB0063] from-[0%] to-[#D50093] to-[100%] shadow-lg transition-all hover:scale-[1.02] hover:opacity-90 text-white font-bold py-2.5 px-6 rounded-lg">
                                    <Pencil size={18} />
                                    Continue writing
                                </Link>
                        ...
                        {/* Structure du morceau — inchangée */}
                        <div className="w-full lg:w-[380px] bg-[#0A0A0A]/80 backdrop-blur-md rounded-xl p-6 border border-neutral-800 flex flex-col gap-5 shadow-2xl">
                            <div className="flex items-center justify-between mb-2">
                                <h3 className="font-bold text-xs tracking-widest uppercase text-white">Structure</h3>
                            </div>
                            <div className="flex flex-col gap-2.5">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        <CircleCheck className="text-emerald-300" size={18} strokeWidth={2.5} />
                                        <span className="text-white font-bold text-sm">Couplet 1</span>
                                    </div>
                                    <span className="text-emerald-300 text-[10px] font-bold uppercase tracking-wider bg-emerald-300/15 px-2 py-0.5 rounded">Ecrit</span>
                                </div>
                            </div>
                            <div className="flex flex-col gap-2.5">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        <CircleMinus className="text-sky-300" size={18} strokeWidth={2.5} />
                                        <span className="text-white font-bold text-sm">Pre-Chorus</span>
                                    </div>
                                    <span className="text-sky-300 text-[10px] font-bold uppercase tracking-wider bg-sky-300/15 px-2 py-0.5 rounded">Brouillon</span>
                                </div>
                            </div>
                            <div className="flex flex-col gap-2.5">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        <CircleMinus className="text-orange-300" size={18} strokeWidth={2.5} />
                                        <span className="text-white font-bold text-sm">Chorus</span>
                                    </div>
                                    <span className="text-orange-300 text-[10px] font-bold uppercase tracking-wider bg-orange-300/15 px-2 py-0.5 rounded">A retravailler</span>
                                </div>
                            </div>
                            <div className="flex flex-col gap-2.5 opacity-60">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        <Circle className="text-[#8A8A93]" size={18} />
                                        <span className="text-[#8A8A93] font-bold text-sm">Verse 2</span>
                                    </div>
                                    <span className="text-[#8A8A93] text-[10px] font-bold uppercase tracking-wider bg-[#8A8A93]/15 px-2 py-0.5 rounded">Vide</span>
                                </div>
                            ...
                            <div className="flex flex-col gap-2.5 opacity-60">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        <Circle className="text-[#8A8A93]" size={18} />
                                        <span className="text-[#8A8A93] font-bold text-sm">Bridge</span>
                                    </div>
                                    <span className="text-[#8A8A93] text-[10px] font-bold uppercase tracking-wider bg-[#8A8A93]/15 px-2 py-0.5 rounded">Vide</span>
                                </div>
                                <div className="h-1.5 w-full bg-neutral-800/50 rounded-full"></div>
                ...
                {/* BLOC 2 : COMMENTS — mocké, pas d'endpoint encore */}
                ...
                <div className="lg:col-span-4 bg-[#151515] rounded-2xl p-6 border border-neutral-800 flex flex-col justify-between">
                    <div>
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <Link href="#" className="text-xs text-neutral-300 hover:text-white transition-colors">Gérer mon abonnement</Link>
                        </div>
                        <div className="flex items-center gap-4 mb-6">
                            <Image src={haslem} alt="Gratuit" width={65} height={65} className="rounded-full" />
                            <div>
                                <h4 className="text-xl font-bold font-syne">Gratuit</h4>
                                <p className="text-xs text-neutral-400 mt-1 leading-snug pr-4">Passez à un abonnement Pro pour débloquer plus d'espace et des fonctionnalités avancées.</p>
                            </div>
                        </div>
                        <div className="mb-4">
                            <div className="flex justify-between text-xs mb-2">
                                <span className="text-neutral-300">Stockage utilisé</span>
                        ...
                        <div className="flex flex-col gap-2 mb-8">
                            <div className="flex justify-between text-sm border-b border-neutral-800 pb-2">
                                ...
                                <span>{projects.length} / Illimité</span>
                            </div>
                            <div className="flex justify-between text-sm">
                                <span className="text-neutral-400">Collaborateurs</span>
                                <span>3 / 5</span>
                            </div>
                        </div>
                    </div>
                ...
                {/* BLOC 4 : RECENT — branché sur l'API */}
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <p className="text-xs text-neutral-500 mt-1">
                                                    Modifié le {new Date(project.updatedAt).toLocaleDateString("fr-FR")} • {project.owner?.name ?? "Inconnu"}
                                                </p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-4">
