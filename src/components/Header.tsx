...
export const Header = () => {
	...
	return (
		<header
			className={`fixed inset-x-0 top-0 z-50 flex justify-center w-full transition-all duration-300 ${isScrolled || menuOpen ? "bg-[#050505]/95 backdrop-blur-xl border-b border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.5)]" : "bg-transparent"}`}
		>
			<div
				className={`flex w-full max-w-[1180px] items-center justify-between gap-4 px-4 text-white sm:px-6 lg:px-8 transition-all duration-300 ${isScrolled ? "py-4" : "py-5 md:py-6"}`}
			>
				<Link
					href="/"
