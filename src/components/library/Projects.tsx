...
export const Projects = () => {
    ...
    const insideProjectList = [
        { id: 1, title: "Let God Sort Em Out", type: "Album", songsCount: 13, collabs: 3, state: "En cours", lastModified: "just now", created: "6 days ago" },
        { id: 2, title: "This Is America", type: "Single", songsCount: 1, collabs: 0, state: "Terminé", lastModified: "just now", created: "6 days ago" },
        { id: 3, title: "Mr. Clean / Modern Day Mugging", type: "EP", songsCount: 6, collabs: 3, state: "En cours", lastModified: "just now", created: "6 days ago" },
        { id: 4, title: "Aquemini", type: "Album", songsCount: 16, collabs: 3, state: "Terminé", lastModified: "just now", created: "6 days ago" },
        { id: 5, title: "The Infamous", type: "Album", songsCount: 16, collabs: 0, state: "En cours", lastModified: "just now", created: "6 days ago" },
        { id: 6, title: "Alfredo 2", type: "Album", songsCount: 14, collabs: 0, state: "En cours", lastModified: "just now", created: "6 days ago" },
        { id: 7, title: "Microphone Champion", type: "Album", songsCount: 17, collabs: 0, state: "En cours", lastModified: "just now", created: "6 days ago" },
        { id: 8, title: "Who Coppin'", type: "Single", songsCount: 1, collabs: 0, state: "Terminé", lastModified: "just now", created: "6 days ago" },
    ];
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-4 flex flex-col">
                                <div className="flex justify-between items-end mb-1">
                                    <span className="text-xs font-bold text-neutral-300 tracking-wide">
                                        {project.type} • {project.songsCount} {project.songsCount > 1 ? "songs" : "song"}
                                    </span>
                                    ...
                                    <div className="flex items-center justify-end gap-2 mt-2">
                                        ...
                                        <div className="flex -space-x-2">
                                            {[...Array(Math.min(project.collabs, 3))].map((_, i) => (
                                                <div key={i} className="w-6 h-6 rounded-full border-2 border-[#111] overflow-hidden relative z-10">
                                                    <Image src={avisProfil} alt="Collab" fill className="object-cover" sizes="24px" />
                                                </div>
                                            ))}
                                        </div>
                                    </div>
