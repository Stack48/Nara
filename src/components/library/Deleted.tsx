...
const DeletedProjectGridItem = ({
    ...
    return (
        ...
        >
            ...
            {/* Actions (Restaurer / Supprimer) - Affichées au hover en haut à droite */}
            <div className="absolute top-3 right-3 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20">
                <button
                    className="p-2 bg-neutral-900/80 backdrop-blur-sm text-neutral-400 hover:text-[#D90097] hover:bg-neutral-800 rounded-lg transition-colors"
                    title="Restaurer"
                    onClick={(e) => {
                        e.stopPropagation();
                ...
                <button
                    className="p-2 bg-neutral-900/80 backdrop-blur-sm text-neutral-400 hover:text-red-500 hover:bg-neutral-800 rounded-lg transition-colors"
